...
int main()
{
    ...
    Static_RNG::distributions::uniform_real_distribution<float> dist(0, 1);
    for (size_t i = 0; i < N_rngs; ++i)
    {
        std::cout << dist(mt) << std::endl;
    }

    Static_RNG::distributions::binomial_distribution<> dist2(10, 0.5);
    for (size_t i = 0; i < N_rngs; ++i)
    {
    ...
    sycl::buffer<Static_RNG::distributions::binomial_distribution<> , 1> dist_buf(N_rngs);
