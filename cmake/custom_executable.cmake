function(add_custom_executable source_file)
    ...
    target_link_libraries(${source_file} PUBLIC Graph ${ONEAPI_LIBRARIES} Math Static_RNG tinymt cppitertools::cppitertools Tracy::TracyClient ${SYCL_GRAPH_DEBUG_LIBRARIES} ${SYCL_GRAPH_LIBRARIES})
