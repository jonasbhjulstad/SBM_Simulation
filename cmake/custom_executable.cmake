function(add_custom_executable source_file)
    ...
    target_link_libraries(${source_file} PUBLIC Sycl_Graph ${ONEAPI_LIBRARIES} Math tinymt cppitertools::cppitertools Tracy::TracyClient ${SYCL_GRAPH_DEBUG_LIBRARIES} ${SYCL_GRAPH_LIBRARIES})
