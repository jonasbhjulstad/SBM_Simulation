...
function(default_configure_target target_name)
    target_compile_options(${target_name} PUBLIC -fsycl ${SYCL_CUSTOM_FLAGS})
    target_link_options(${target_name} PUBLIC -fsycl -fsycl-targets=${${PROJECT_NAME}_SYCL_TARGETS})
