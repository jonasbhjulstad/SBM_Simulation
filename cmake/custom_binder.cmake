function(add_custom_binder source_file)
    ...
    target_link_libraries(${source_file} PRIVATE Simulation Static_RNG::Static_RNG TBB::tbb Eigen3::Eigen ortools::ortools)
    target_compile_options(${source_file} PRIVATE ${DEFAULT_WARNING_FLAGS})
    target_compile_options(${source_file} PRIVATE ${SYCL_CUSTOM_FLAGS} -fPIC)
    target_include_directories(${source_file} PUBLIC ${SYCL_GRAPH_INCLUDE_DIR})
    target_link_options(${source_file} PRIVATE ${SYCL_CUSTOM_FLAGS} -fPIC)
endfunction()
