...
import module SIR_SBM.simulation.buffers;
import module SIR_SBM.epidemiological;
import module SIR_SBM.sycl.buffers;
import module SIR_SBM.population_count;
import module SIR_SBM.exceptions;
export module SIR_SBM.simulation;
...
export sycl::event run_simulation(sycl::queue &q, std::shared_ptr<Sim_Buffers> &SB,
                           const Sim_Param& p) {
