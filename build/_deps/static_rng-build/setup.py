...
#         cmake_args = ['-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=/home/deb/Documents/SBM_Graph/build/_deps/static_rng-build]
...
setup(
    ...
    package_data={'Static_RNG':['/home/deb/Documents/SBM_Graph/build/_deps/static_rng-build/Binder.so']},
