...
struct Simulation_t {
  ...
  Simulation_t(sycl::queue &q, const Sim_Param &sim_param, const std::string &control_type = "Community", const std::string &simulation_type = "Excitation");

  Simulation_t(sycl::queue &q, const Sim_Param &sim_param,
...
private:
  void write_initial_steps(sycl::queue &q, const Sim_Param &p, Sim_Buffers &b,
