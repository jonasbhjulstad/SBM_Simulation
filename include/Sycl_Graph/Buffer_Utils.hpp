...
extern template std::vector<SIR_State> read_buffer(cl::sycl::buffer<SIR_State,3>& buf, cl::sycl::queue& q, cl::sycl::event& event);
extern template std::vector<State_t> read_buffer<State_t, 3>(cl::sycl::buffer<State_t,3>& buf, cl::sycl::queue& q, cl::sycl::event& event);
