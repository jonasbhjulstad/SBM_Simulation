...
namespace Network_Models
{
    ...
    struct Sycl_SIR_Bernoulli_Network : public Network<SIR_Bernoulli_Param<>, 3, Nt, SIR_Bernoulli_Network<RNG, Nt, NV, NE>>
    {
        ...
        // using RNG_accessor = sycl::accessor<Sycl_Graph::random::default_rng, 1, sycl::access::mode::read_write, sycl::access::target::local>;
        using RNG_accessor = sycl::accessor<Sycl_Graph::random::default_rng, 1, sycl::access::mode::read_write, sycl::access::target::device>;
        const uint32_t t = 0;
                                                                                                                                              ...
                                                                                                                                              q(q), p0{p_I0, p_R0}
        {
            std::transform(seeds.begin(), seeds.end(), rng_vec.begin(), [](const auto &seed)
                           { return Sycl_Graph::random::default_rng(seed); });
        }
