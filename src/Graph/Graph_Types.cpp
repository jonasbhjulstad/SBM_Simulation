...
std::vector<uint32_t> get_from(const std::vector<std::pair<uint32_t, uint32_t>> &edges)
{
    std::vector<uint32_t> result(edges.size());
    std::transform(edges.begin(), edges.end(), result.begin(), [](auto edge)
                   { return edge.first; });
...
std::vector<uint32_t> get_to(const std::vector<std::pair<uint32_t, uint32_t>> &edges)
{
    std::vector<uint32_t> result(edges.size());
    std::transform(edges.begin(), edges.end(), result.begin(), [](auto edge)
                   { return edge.second; });
